...
void MPU9150AccelFactor(tMPU9150 *psInst, float *pfAccelFactor)
{
  if (pfAccelFactor)
    *pfAccelFactor = g_fMPU9150AccelFactors[psInst->ui8AccelAfsSel];
}

void MPU9150GyroFactor(tMPU9150 *psInst, float *pfGyroFactor)
{
  if (pfGyroFactor)
    *pfGyroFactor = g_fMPU9150GyroFactors[psInst->ui8GyroFsSel];
}
