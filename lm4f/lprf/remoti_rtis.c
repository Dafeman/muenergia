...
//
//*****************************************************************************
//extern uint_fast8_t RTI_ReadItem(uint8_t ui8ItemID, uint8_t ui8Length, uint8_t *pui8Value);
uint_fast8_t RTI_ReadItem(uint8_t ui8ItemID, uint8_t ui8Length, uint8_t *pui8Value)
{
  //
...
//
//*****************************************************************************
//extern uint_fast8_t RTI_WriteItem(uint8_t ui8ItemID, uint8_t ui8Length, const uint8_t *pui8Value);
uint_fast8_t RTI_WriteItem(uint8_t ui8ItemID, uint8_t ui8Length, const uint8_t *pui8Value)
{
  //
...
RTI_InitReq( void )
{
    ...
    //##### INTERNAL BEGIN #####
      UARTprintf("Sending Init Request\n");
    //##### INTERNAL END #####
}
...
RTI_DisableSleepReq( void )
{
    tRemoTIMsg sMsg;
    //##### INTERNAL BEGIN #####
      UARTprintf("Sending Disable Sleep Req\n");
    //##### INTERNAL END #####
